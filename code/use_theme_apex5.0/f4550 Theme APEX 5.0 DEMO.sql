...
prompt APPLICATION 300 - f4550 Theme APEX 5.0 DEMO
--
-- Application Export:
--   Application:     300
--   Name:            f4550 Theme APEX 5.0 DEMO
--   Date and Time:   00:28 星期六 5月 13, 2017
...
,p_checksum_salt_last_reset=>'20170513002703'
...
,p_last_upd_yyyymmddhh24miss=>'20170513002703'
...
,p_last_updated_by=>'OOS_USER'
,p_last_upd_yyyymmddhh24miss=>'20170513001107'
);
wwv_flow_api.create_page_plug(
...
'apex.jQuery("div.a-Login-header span").removeClass("a-Login-logo gi-icon-apex-logo-icon").addClass("dm-Logo gi-icon-apex-logo-icon"); ',
'apex.jQuery("div.a-Login-header span").css({width: "96px", height: "96px"});'))
);
