...
,p_default_application_id=>85497
,p_default_owner=>'T4'
);
end;
/
...
prompt APPLICATION 85497 - f4000 Theme APEX 5.0 DEMO
--
-- Application Export:
--   Application:     85497
--   Name:            f4000 Theme APEX 5.0 DEMO
--   Date and Time:   06:00 Saturday May 20, 2017
...
,p_display_id=>nvl(wwv_flow_application_install.get_application_id,85497)
...
,p_checksum_salt_last_reset=>'20170514153622'
...
,p_authentication_id=>wwv_flow_api.id(14970058217682064185)
...
,p_last_upd_yyyymmddhh24miss=>'20170514153622'
...
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(14969614800943198152)
,p_name=>'home.page.tasks'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969615045782198153)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969622562694198161)
...
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(14969696228676392474)
,p_name=>'APEX 5 - Administration'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969696497405392474)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969696894031392475)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969697286654392475)
,p_list_item_display_sequence=>200
,p_list_item_link_text=>'Manage Service'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969697729914392475)
,p_list_item_display_sequence=>210
,p_list_item_link_text=>'Manage Service'
,p_list_item_link_target=>'f?p=4350:21:&SESSION.'
,p_parent_list_item_id=>wwv_flow_api.id(14969697286654392475)
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969698117958392475)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969698466316392475)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969698938462392476)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969699280150392476)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969699695418392476)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969700064018392476)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969700482222392476)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969700863926392476)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969701327260392476)
...
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(14969704152923392478)
,p_name=>'APEX 5 - Help'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969704392663392478)
,p_list_item_display_sequence=>10
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969704783627392479)
,p_list_item_display_sequence=>20
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969705257116392479)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969705587357392479)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969706003503392479)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969706406033392479)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969706810485392479)
...
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(14969728310136515013)
,p_name=>'APEX 5 - Tabs'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969728463352515014)
,p_list_item_display_sequence=>100
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969728862267515014)
,p_list_item_display_sequence=>110
,p_list_item_link_text=>'Database Applications'
,p_list_item_link_target=>'f?p=4000:1500:&SESSION.::&DEBUG.::P1500_SHOW:DATABASE:'
,p_parent_list_item_id=>wwv_flow_api.id(14969728463352515014)
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969729326286515014)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969729758341515014)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969730140022515015)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969730512420515015)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969730912301515015)
,p_list_item_display_sequence=>150
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969731336770515015)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969731725445515015)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969732126695515015)
...
,p_parent_list_item_id=>wwv_flow_api.id(14969731725445515015)
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969732543223515015)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969732877741515015)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969733348703515016)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969733729862515016)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969734092452515016)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969734524835515016)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969734893010515016)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969735341420515017)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969735724065515017)
,p_list_item_display_sequence=>200
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969736151659515017)
,p_list_item_display_sequence=>210
,p_list_item_link_text=>'Object Browser'
,p_list_item_link_target=>'f?p=4500:1001:&SESSION.'
,p_parent_list_item_id=>wwv_flow_api.id(14969735724065515017)
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969736482541515017)
,p_list_item_display_sequence=>220
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969736958945515017)
,p_list_item_display_sequence=>230
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969737327889515017)
,p_list_item_display_sequence=>240
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969737729493515018)
,p_list_item_display_sequence=>241
,p_list_item_link_text=>'All Utilities'
,p_list_item_link_target=>'f?p=4500:1005:&SESSION.'
,p_parent_list_item_id=>wwv_flow_api.id(14969737327889515017)
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969738110760515018)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969738542169515018)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969738933541515018)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969739322351515018)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969739738783515018)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969740096105515018)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969740525724515018)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969740952306515018)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969741296108515019)
,p_list_item_display_sequence=>250
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969741670710515019)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969742079097515019)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969742504582515019)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969742875869515019)
,p_list_item_display_sequence=>300
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969743262981515019)
,p_list_item_display_sequence=>310
,p_list_item_link_text=>'Milestones'
,p_list_item_link_target=>'f?p=4800:6006:&SESSION.'
,p_parent_list_item_id=>wwv_flow_api.id(14969742875869515019)
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969743687714515019)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969744083059515019)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969744483758515019)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969744936568515020)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969745324414515020)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969745692061515020)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969746104391515020)
,p_list_item_display_sequence=>361
,p_list_item_link_text=>'All Utilities'
,p_list_item_link_target=>'f?p=4800:2:&SESSION.:'
,p_parent_list_item_id=>wwv_flow_api.id(14969745692061515020)
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969746525356515020)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969746915404515020)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969747354694515020)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969747691848515020)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969748078642515020)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969748463136515021)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969748932847515021)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969749352408515021)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969749668505515021)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969750117692515021)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969750552759515021)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969750952761515021)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969751275823515021)
,p_list_item_display_sequence=>400
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969751734118515022)
...
,p_parent_list_item_id=>wwv_flow_api.id(14969751275823515021)
,p_list_item_current_type=>'TARGET_PAGE'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969752080665515022)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969752476805515022)
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969752893966515022)
...
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(14969795882255175679)
,p_name=>'Home Page APEX 4.0 list'
,p_list_status=>'PUBLIC'
);
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969796122210175679)
,p_list_item_display_sequence=>10
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969796515020175680)
,p_list_item_display_sequence=>20
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969796926348175680)
,p_list_item_display_sequence=>30
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969797328161175680)
,p_list_item_display_sequence=>50
,p_list_item_link_text=>'Utilities'
,p_list_item_link_target=>'f?p=&APP_ID.:1:&SESSION.::&DEBUG.::::'
...
wwv_flow_api.create_list_item(
 p_id=>wwv_flow_api.id(14969797685978175680)
,p_list_item_display_sequence=>60
,p_list_item_link_text=>'Export / Import'
,p_list_item_link_target=>'f?p=&APP_ID.:1:&SESSION.::&DEBUG.::::'
,p_list_item_icon=>'app-builder-export-import'
,p_list_item_icon_attributes=>'width="18" height="128" alt=""'
,p_list_item_current_type=>'COLON_DELIMITED_PAGE_LIST'
);
end;
/
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(14969539674865996496)
...
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(14969540002263096495)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IR'
,p_attribute_01=>'LEGACY'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(14969540083904096496)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_CSS_CALENDAR'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(14969540173383096496)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_DISPLAY_SELECTOR'
,p_attribute_01=>'N'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(14969540318206096496)
,p_plugin_type=>'REGION TYPE'
,p_plugin=>'NATIVE_IG'
);
wwv_flow_api.create_plugin_setting(
 p_id=>wwv_flow_api.id(14969540461294096496)
,p_plugin_type=>'ITEM TYPE'
...
wwv_flow_api.create_security_scheme(
 p_id=>wwv_flow_api.id(14969615231602198154)
,p_name=>'Flow: CREATE'
...
wwv_flow_api.create_security_scheme(
 p_id=>wwv_flow_api.id(14969624854000198162)
,p_name=>'Flow: ADMIN'
,p_scheme_type=>'PLUGIN_COM.ORACLE.APEX.DEVELOPER_AUTHORIZATION'
...
wwv_flow_api.create_security_scheme(
 p_id=>wwv_flow_api.id(14969630941990336833)
...
wwv_flow_api.create_security_scheme(
 p_id=>wwv_flow_api.id(14969638678287336836)
...
wwv_flow_api.create_security_scheme(
 p_id=>wwv_flow_api.id(14969646077796336839)
...
wwv_flow_api.create_security_scheme(
 p_id=>wwv_flow_api.id(14969646774920336839)
...
wwv_flow_api.create_security_scheme(
 p_id=>wwv_flow_api.id(14969655518031336842)
...
wwv_flow_api.create_menu(
 p_id=>wwv_flow_api.id(15230340359532763581)
,p_name=>'Breadcrumb'
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(14969792027705890712)
,p_parent_id=>wwv_flow_api.id(14969792206702900464)
,p_short_name=>'Application &APP_ID.'
,p_link=>'f?p=&APP_ID.:1:&SESSION.::&DEBUG.:RP::'
,p_page_id=>1
);
wwv_flow_api.create_menu_option(
 p_id=>wwv_flow_api.id(14969792206702900464)
,p_parent_id=>0
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(14969541388055105765)
,p_theme_id=>4000
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(14969541651706105766)
,p_theme_id=>4000
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(14969541838274105766)
,p_theme_id=>4000
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(14969542065808105766)
,p_page_template_id=>wwv_flow_api.id(14969541838274105766)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(14969542397041105766)
,p_page_template_id=>wwv_flow_api.id(14969541838274105766)
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(14969542647881105766)
,p_theme_id=>4000
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(14969542792722105766)
,p_theme_id=>4000
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(14969543088317105767)
,p_page_template_id=>wwv_flow_api.id(14969542792722105766)
,p_name=>'Dialog Area'
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(14969543341966105767)
,p_theme_id=>4000
...
begin
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(14969543561208105767)
,p_page_template_id=>wwv_flow_api.id(14969543341966105767)
,p_name=>'Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(14969543929097105767)
,p_page_template_id=>wwv_flow_api.id(14969543341966105767)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(14969544219013105767)
,p_page_template_id=>wwv_flow_api.id(14969543341966105767)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(14969544464642105767)
,p_page_template_id=>wwv_flow_api.id(14969543341966105767)
,p_name=>'Right Side Bar'
,p_placeholder=>'REGION_POSITION_03'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(14969544797407105767)
,p_page_template_id=>wwv_flow_api.id(14969543341966105767)
,p_name=>'After Body'
,p_placeholder=>'REGION_POSITION_04'
,p_has_grid_support=>false
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(14969545133501105767)
,p_page_template_id=>wwv_flow_api.id(14969543341966105767)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(14969545379285105767)
,p_page_template_id=>wwv_flow_api.id(14969543341966105767)
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(14969545590432105767)
,p_theme_id=>4000
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(14969545919841105768)
,p_page_template_id=>wwv_flow_api.id(14969545590432105767)
,p_name=>'Wizard Body'
,p_placeholder=>'BODY'
,p_has_grid_support=>true
,p_glv_new_row=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(14969546200648105768)
,p_page_template_id=>wwv_flow_api.id(14969545590432105767)
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(14969546520652105768)
,p_page_template_id=>wwv_flow_api.id(14969545590432105767)
,p_name=>'Wizard Title'
,p_placeholder=>'REGION_POSITION_02'
,p_has_grid_support=>true
...
wwv_flow_api.create_page_tmpl_display_point(
 p_id=>wwv_flow_api.id(14969546832646105768)
,p_page_template_id=>wwv_flow_api.id(14969545590432105767)
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(14969547040856105768)
,p_theme_id=>4000
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(14969547167827105768)
,p_theme_id=>4000
,p_name=>'Popup Info'
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(15205900232185983165)
,p_theme_id=>20
,p_name=>'Login'
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(15205900305876983167)
,p_theme_id=>20
,p_name=>'No Tabs'
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(15205900524145983168)
,p_theme_id=>20
...
begin
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(15205900712178983168)
,p_theme_id=>20
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(15205900908426983169)
,p_theme_id=>20
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(15205901124464983169)
,p_theme_id=>20
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(15205901323868983169)
,p_theme_id=>20
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(15205901510935983169)
,p_theme_id=>20
,p_name=>'Popup'
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(15205901731398983170)
,p_theme_id=>20
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(15205901930666983170)
,p_theme_id=>20
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(15205902107481983170)
,p_theme_id=>20
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(14969542006554096569)
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(14969590571274105783)
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(14969590736170105783)
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(14969591221481105783)
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(14969591479171105784)
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(14969591566887105784)
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(14969591730581105784)
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(14969591780837105784)
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(15205902308791983170)
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(15205902511298983171)
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(15205902705213983172)
...
wwv_flow_api.create_button_templates(
 p_id=>wwv_flow_api.id(15205902931059983172)
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(14969547376568105768)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(14969547634207105768)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(14969547816909105768)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(14969547977203105769)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(14969548194162105769)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(14969548435036105769)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(14969548614879105769)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(14969548806833105769)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(14969548967530105769)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(14969549212236105769)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(14969549434878105769)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(14969551785743105770)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(14969554172082105770)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(14969554515938105771)
,p_plug_template_id=>wwv_flow_api.id(14969554172082105770)
,p_name=>'Sub Regions'
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(14969554695493105771)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(14969557522999105772)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(14969559678626105772)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(14969560550815105772)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(14969560707862105773)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(14969560951980105773)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(14969561155503105773)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(14969561328826105773)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(14969561538540105773)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<div class="a-PageColumn resize #REGION_CSS_CLASSES#" #REGION_ATTRIBUTES# id="#REGION_STATIC_ID#">',
'  #BODY#',
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(14969561731133105773)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(14969561874960105773)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(14969562301061105773)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(14969564757959105774)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(14969564950521105774)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(14969567116519105775)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(14969567317296105775)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<div class="a-TabsContainer #REGION_CSS_CLASSES#" #REGION_ATTRIBUTES# id="#REGION_STATIC_ID#">',
'  <div class="a-Tabs-toolbar a-Toolbar">',
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(14969567498481105775)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(14969567737710105775)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(14969567881991105775)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(14969568068838105775)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(14969568321627105775)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(14969568505581105775)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<div class="a-TabsContainer #REGION_CSS_CLASSES#" #REGION_ATTRIBUTES# id="#REGION_STATIC_ID#">',
'  <div class="a-Tabs-toolbar a-Toolbar">',
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(14969568740548105775)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="aRegion aActionRegion #REGION_CSS_CLASSES#" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="aRegionHeading">',
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(14969568892843105775)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
begin
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(14969569105180105776)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(14969569338654105776)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(14969569461224105776)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<section class="aRegion aActionRegion confirmRegion #REGION_CSS_CLASSES#" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'  <div class="aRegionHeading">',
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(14969569757865105776)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(14969569861777105776)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(14969570094491105776)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15205903122437983172)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15205903415234983173)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15205903706308983173)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15205904010965983173)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15205904303389983173)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15205904630162983174)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15205904910178983174)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15205905216235983174)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15205905500758983174)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15205905814404983174)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15205906105650983175)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15205906431869983175)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15205906704075983175)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15205907031915983175)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15205907318129983175)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15205907611208983176)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15205907901732983176)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15205908217720983176)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15205908516906983176)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15205908803391983176)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15205909120554983177)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(15205909417269983177)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(14969580861546105780)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(14969581089175105780)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(14969581301041105780)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(14969581533074105780)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(14969581660693105780)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(14969581888502105780)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(14969583469302105781)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(14969585904373105781)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(14969586462368105782)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(14969586729108105782)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(14969586960348105782)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(14969587271692105782)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(14969587517434105782)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(14969587756062105782)
,p_list_template_current=>'<li class="a-LinksList-item is-current #A03#"><a href="#LINK#" class="a-LinksList-link" #A02#><span class="a-LinksList-icon"><span class="t-Icon #IMAGE#"></span></span><span class="a-LinksList-label">#TEXT#</span><span class="a-LinksList-badge">#A01#'
||'</span></a></li>'
,p_list_template_noncurrent=>'<li class="a-LinksList-item #A03#"><a href="#LINK#" class="a-LinksList-link" #A02#><span class="a-LinksList-icon"><span class="t-Icon #IMAGE#"></span></span><span class="a-LinksList-label">#TEXT#</span><span class="a-LinksList-badge">#A01#</span></a>'
||'</li>'
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(14969589089007105782)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(14969589291118105782)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(15205909703778983177)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(15205910027169983178)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(15205910326667983178)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(15205910622143983179)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(15205910907525983179)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(15205911201371983179)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(15205911510250983180)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(15205911815496983180)
...
begin
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(15205912120080983180)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<td><img src="#IMAGE_PREFIX#themes/theme_20/topTabL.gif" /></td>',
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(15205912425888983181)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(15205912703274983181)
,p_list_template_current=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(15205913005005983181)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(15205913324928983181)
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(15205913612743983182)
,p_list_template_current=>'<li class="t20current"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(15205913925116983182)
,p_list_template_current=>'<li class="t20current"><a href="#LINK#">#TEXT#</a></li>'
,p_list_template_noncurrent=>'<li><a href="#LINK#">#TEXT#</a></li>'
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(15205914201363983182)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(14969570307136105776)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(14969570514870105776)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(14969570669099105776)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(14969570952657105776)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(14969574061971105778)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(14969574328459105778)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(14969575101238105778)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(14969575278125105778)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(14969575474235105778)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(14969577956725105779)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(14969579277302105779)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(14969579487300105779)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(14969579722854105779)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(14969579863916105779)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(14969580114819105780)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(14969580299959105780)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(14969580546993105780)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(14969580694490105780)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(15205914522491983182)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(15205915009700983185)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(15205915532839983185)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(15205916015016983185)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(15205916506430983186)
...
begin
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(15205917019370983186)
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(15205917502103983187)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(14969589468065105783)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(14969589621647105783)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(14969589745399105783)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(14969589831792105783)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(14969589872509105783)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(14969590003689105783)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(14969590120814105783)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(14969590241200105783)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(14969590327218105783)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(14969590401054105783)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(14969590486678105783)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(15205918029144983188)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(15205918124999983188)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(15205918200897983188)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(15205918318889983188)
...
wwv_flow_api.create_field_template(
 p_id=>wwv_flow_api.id(15205918421613983188)
...
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(14969591928270105784)
...
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(15205918519235983188)
...
wwv_flow_api.create_menu_template(
 p_id=>wwv_flow_api.id(15205918604067983189)
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(14969592104968105784)
,p_page_name=>'winlov'
...
wwv_flow_api.create_popup_lov_template(
 p_id=>wwv_flow_api.id(15205919313017983191)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(14969592013909105784)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(15205918716470983189)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(15205918930874983190)
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(15205919120862983190)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(14969592542730105784)
,p_theme_id=>4000
...
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(14969543341966105767)
,p_default_dialog_template=>wwv_flow_api.id(14969547040856105768)
,p_error_template=>wwv_flow_api.id(14969545590432105767)
,p_printer_friendly_template=>wwv_flow_api.id(14969543341966105767)
,p_default_button_template=>wwv_flow_api.id(14969590571274105783)
,p_default_region_template=>wwv_flow_api.id(14969562301061105773)
,p_default_chart_template=>wwv_flow_api.id(14969562301061105773)
,p_default_form_template=>wwv_flow_api.id(14969562301061105773)
,p_default_reportr_template=>wwv_flow_api.id(14969562301061105773)
,p_default_tabform_template=>wwv_flow_api.id(14969562301061105773)
,p_default_wizard_template=>wwv_flow_api.id(14969568068838105775)
,p_default_menur_template=>wwv_flow_api.id(14969554172082105770)
,p_default_listr_template=>wwv_flow_api.id(14969562301061105773)
,p_default_irr_template=>wwv_flow_api.id(14969559678626105772)
,p_default_report_template=>wwv_flow_api.id(14969575474235105778)
,p_default_label_template=>wwv_flow_api.id(14969589831792105783)
,p_default_menu_template=>wwv_flow_api.id(14969591928270105784)
,p_default_calendar_template=>wwv_flow_api.id(14969592013909105784)
,p_default_list_template=>wwv_flow_api.id(14969581888502105780)
,p_default_nav_list_template=>wwv_flow_api.id(14969586462368105782)
,p_default_top_nav_list_temp=>wwv_flow_api.id(14969586462368105782)
...
wwv_flow_api.create_theme(
 p_id=>wwv_flow_api.id(15205919509858983192)
,p_theme_id=>20
...
,p_nav_bar_type=>'NAVBAR'
,p_is_locked=>false
,p_default_page_template=>wwv_flow_api.id(15205900712178983168)
,p_error_template=>wwv_flow_api.id(15205900712178983168)
,p_printer_friendly_template=>wwv_flow_api.id(15205901731398983170)
,p_breadcrumb_display_point=>'REGION_POSITION_01'
,p_login_template=>wwv_flow_api.id(15205900232185983165)
,p_default_button_template=>wwv_flow_api.id(15205902308791983170)
,p_default_region_template=>wwv_flow_api.id(15205907611208983176)
,p_default_chart_template=>wwv_flow_api.id(15205904630162983174)
,p_default_form_template=>wwv_flow_api.id(15205904910178983174)
,p_default_reportr_template=>wwv_flow_api.id(15205907611208983176)
,p_default_tabform_template=>wwv_flow_api.id(15205907611208983176)
,p_default_wizard_template=>wwv_flow_api.id(15205909120554983177)
,p_default_menur_template=>wwv_flow_api.id(15205903706308983173)
,p_default_listr_template=>wwv_flow_api.id(15205907611208983176)
,p_default_report_template=>wwv_flow_api.id(15205916015016983185)
,p_default_label_template=>wwv_flow_api.id(15205918200897983188)
,p_default_menu_template=>wwv_flow_api.id(15205918519235983188)
,p_default_list_template=>wwv_flow_api.id(15205913925116983182)
,p_default_option_label=>wwv_flow_api.id(15205918200897983188)
,p_default_required_label=>wwv_flow_api.id(15205918421613983188)
,p_default_page_transition=>'NONE'
,p_default_popup_transition=>'NONE'
...
wwv_flow_api.create_theme_style(
 p_id=>wwv_flow_api.id(14969592306553105784)
,p_theme_id=>4000
,p_name=>'Standard'
,p_css_file_urls=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(14969549663409105769)
,p_theme_id=>4000
,p_name=>'ALERT_TYPE'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(14969550071977105769)
,p_theme_id=>4000
,p_name=>'DISPLAY'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(14969552120917105770)
,p_theme_id=>4000
,p_name=>'REGION_TITLE'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(14969552556426105770)
,p_theme_id=>4000
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(14969553082829105770)
,p_theme_id=>4000
,p_name=>'REGION_STYLE'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(14969555237681105771)
,p_theme_id=>4000
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(14969556806897105771)
,p_theme_id=>4000
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(14969571174177105776)
,p_theme_id=>4000
,p_name=>'BADGE_LAYOUT'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(14969572841877105777)
,p_theme_id=>4000
,p_name=>'BADGE_SIZE'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(14969575839092105778)
,p_theme_id=>4000
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(14969576183684105778)
,p_theme_id=>4000
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(14969576574668105779)
,p_theme_id=>4000
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(14969577411508105779)
,p_theme_id=>4000
,p_name=>'REPORT_WIDTH'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(14969582450040105781)
,p_theme_id=>4000
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(14969583850764105781)
,p_theme_id=>4000
,p_name=>'LAYOUT'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(14969590939504105783)
,p_theme_id=>4000
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(14969592677495105785)
,p_theme_id=>4000
,p_name=>'SPACING_LEFT'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(14969593478836105785)
,p_theme_id=>4000
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(14969594724595105786)
,p_theme_id=>4000
,p_name=>'BUTTON_SIZE'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(14969596276276105786)
,p_theme_id=>4000
,p_name=>'BUTTON_SET'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(14969597934762105787)
,p_theme_id=>4000
,p_name=>'BUTTON_TYPE'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(14969599941550105788)
,p_theme_id=>4000
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(14969601065427105789)
,p_theme_id=>4000
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(14969601919979105789)
,p_theme_id=>4000
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(14969602754706105789)
,p_theme_id=>4000
,p_name=>'LABEL_WIDTH'
...
wwv_flow_api.create_template_opt_group(
 p_id=>wwv_flow_api.id(14969604729060105790)
,p_theme_id=>4000
,p_name=>'HEIGHT'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969549917491105769)
,p_theme_id=>4000
,p_name=>'ERROR'
,p_display_name=>'Error'
,p_display_sequence=>1
,p_region_template_id=>wwv_flow_api.id(14969549434878105769)
,p_css_classes=>'a-Alert--danger'
,p_group_id=>wwv_flow_api.id(14969549663409105769)
,p_template_types=>'REGION'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969550289956105769)
,p_theme_id=>4000
,p_name=>'HORIZONTAL'
...
,p_group_id=>wwv_flow_api.id(14969550071977105769)
,p_template_types=>'REGION'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969550475709105769)
,p_theme_id=>4000
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969550699971105769)
,p_theme_id=>4000
,p_name=>'REMOVE_ICON'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969550925385105770)
,p_theme_id=>4000
,p_name=>'SUCCESS'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969551108715105770)
,p_theme_id=>4000
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969551289483105770)
,p_theme_id=>4000
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969551464219105770)
,p_theme_id=>4000
,p_name=>'WARNING'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969551754458105770)
,p_theme_id=>4000
,p_name=>'WIZARD'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969552288533105770)
,p_theme_id=>4000
,p_name=>'ACCESSIBLEHEADING'
,p_display_name=>'Hidden (Accessible)'
,p_display_sequence=>1
,p_region_template_id=>wwv_flow_api.id(14969551785743105770)
,p_css_classes=>'a-ButtonRegion--accessibleTitle'
,p_group_id=>wwv_flow_api.id(14969552120917105770)
,p_template_types=>'REGION'
,p_help_text=>'Use this option to add a visually hidden heading which is accessible for screen readers, but otherwise not visible to users.'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969552759182105770)
,p_theme_id=>4000
,p_name=>'NOPADDING'
...
,p_group_id=>wwv_flow_api.id(14969552556426105770)
,p_template_types=>'REGION'
,p_is_advanced=>'N'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969552900657105770)
,p_theme_id=>4000
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969553281138105770)
,p_theme_id=>4000
...
,p_group_id=>wwv_flow_api.id(14969553082829105770)
,p_template_types=>'REGION'
,p_is_advanced=>'N'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969553534889105770)
,p_theme_id=>4000
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969553668968105770)
,p_theme_id=>4000
,p_name=>'SLIMPADDING'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969553889926105770)
,p_theme_id=>4000
,p_name=>'VISIBLE'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969554114772105770)
,p_theme_id=>4000
,p_name=>'WIZARDDIALOG'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969555030563105771)
,p_theme_id=>4000
,p_name=>'ACCESSIBLEHEADING'
,p_display_name=>'Hidden (Accessible)'
,p_display_sequence=>1
,p_region_template_id=>wwv_flow_api.id(14969554695493105771)
,p_css_classes=>'a-Region--accessibleHeader'
,p_group_id=>wwv_flow_api.id(14969552120917105770)
,p_template_types=>'REGION'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969555379371105771)
,p_theme_id=>4000
,p_name=>'AUTOSCROLL'
...
,p_group_id=>wwv_flow_api.id(14969555237681105771)
,p_template_types=>'REGION'
,p_is_advanced=>'N'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969555587247105771)
,p_theme_id=>4000
,p_name=>'BORDERLESS'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969555793953105771)
,p_theme_id=>4000
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969556017378105771)
,p_theme_id=>4000
,p_name=>'HIDDEN'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969556219628105771)
,p_theme_id=>4000
,p_name=>'NOPADDING'
,p_display_name=>'No Padding'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969556407035105771)
,p_theme_id=>4000
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969556656442105771)
,p_theme_id=>4000
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969556979625105771)
,p_theme_id=>4000
,p_name=>'SIDEBAR'
...
,p_group_id=>wwv_flow_api.id(14969556806897105771)
,p_template_types=>'REGION'
,p_is_advanced=>'N'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969557206802105771)
,p_theme_id=>4000
,p_name=>'SIMPLE'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969557427258105772)
,p_theme_id=>4000
,p_name=>'SLIMPADDING'
,p_display_name=>'Slim Padding'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969557820182105772)
,p_theme_id=>4000
,p_name=>'AUTOSCROLL'
,p_display_name=>'Scroll'
,p_display_sequence=>1
,p_region_template_id=>wwv_flow_api.id(14969557522999105772)
,p_css_classes=>'a-Region--scrollAuto'
,p_group_id=>wwv_flow_api.id(14969555237681105771)
,p_template_types=>'REGION'
,p_is_advanced=>'N'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969558025326105772)
,p_theme_id=>4000
,p_name=>'BORDERLESS'
,p_display_name=>'Borderless'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969558242310105772)
,p_theme_id=>4000
,p_name=>'COLLAPSED'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969558375684105772)
,p_theme_id=>4000
,p_name=>'EXPANDED'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969558651334105772)
,p_theme_id=>4000
,p_name=>'FLUSHREGION'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969558838389105772)
,p_theme_id=>4000
,p_name=>'NOPADDING'
,p_display_name=>'No Padding'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969559049892105772)
,p_theme_id=>4000
,p_name=>'SCROLLWITHSHADOWS'
,p_display_name=>'Scroll (with Shadows)'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969559220844105772)
,p_theme_id=>4000
,p_name=>'SIDEBAR'
,p_display_name=>'Sidebar'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969559389973105772)
,p_theme_id=>4000
,p_name=>'SLIMPADDING'
,p_display_name=>'Slim Padding'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969559571990105772)
,p_theme_id=>4000
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969560018339105772)
,p_theme_id=>4000
,p_name=>'ICONLABELSRIGHT'
,p_display_name=>'Icon Labels on Right'
,p_display_sequence=>1
,p_region_template_id=>wwv_flow_api.id(14969559678626105772)
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969560234531105772)
,p_theme_id=>4000
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969560386014105772)
,p_theme_id=>4000
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969562219638105773)
,p_theme_id=>4000
,p_name=>'USED_IN_DIALOG'
,p_display_name=>'Used in Dialog'
,p_display_sequence=>1
,p_region_template_id=>wwv_flow_api.id(14969561874960105773)
,p_css_classes=>'a-ProcessingRegion--dialog'
,p_template_types=>'REGION'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969562570230105773)
,p_theme_id=>4000
,p_name=>'ACCESSIBLEHEADING'
,p_display_name=>'Hidden (Accessible)'
,p_display_sequence=>1
,p_region_template_id=>wwv_flow_api.id(14969562301061105773)
,p_css_classes=>'a-Region--accessibleHeader'
,p_group_id=>wwv_flow_api.id(14969552120917105770)
,p_template_types=>'REGION'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969562833669105773)
,p_theme_id=>4000
,p_name=>'AUTOSCROLL'
,p_display_name=>'Scroll'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969563041402105773)
,p_theme_id=>4000
,p_name=>'BORDERLESS'
,p_display_name=>'Borderless'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969563193272105773)
,p_theme_id=>4000
,p_name=>'DEFAULTPADDING'
,p_display_name=>'Default Padding'
,p_display_sequence=>30
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969563361410105774)
,p_theme_id=>4000
,p_name=>'HIDDEN'
,p_display_name=>'Hidden'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969563595084105774)
,p_theme_id=>4000
,p_name=>'NOPADDING'
,p_display_name=>'No Padding'
,p_display_sequence=>10
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969563851931105774)
,p_theme_id=>4000
,p_name=>'REMOVE_TOP_BORDER'
,p_display_name=>'Remove Top Border'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969564010346105774)
,p_theme_id=>4000
,p_name=>'SCROLLWITHSHADOWS'
,p_display_name=>'Scroll (with Shadows)'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969564205163105774)
,p_theme_id=>4000
,p_name=>'SIDEBAR'
,p_display_name=>'Sidebar'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969564446295105774)
,p_theme_id=>4000
,p_name=>'SIMPLE'
,p_display_name=>'Simple'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969564646253105774)
,p_theme_id=>4000
,p_name=>'SLIMPADDING'
,p_display_name=>'Slim Padding'
,p_display_sequence=>20
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969565163427105774)
,p_theme_id=>4000
,p_name=>'ACCESSIBLEHEADING'
,p_display_name=>'Hidden (Accessible)'
,p_display_sequence=>1
,p_region_template_id=>wwv_flow_api.id(14969564950521105774)
,p_css_classes=>'a-Region--accessibleHeader'
,p_group_id=>wwv_flow_api.id(14969552120917105770)
,p_template_types=>'REGION'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969565453520105774)
,p_theme_id=>4000
,p_name=>'AUTOSCROLL'
,p_display_name=>'Scroll'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969565561483105774)
,p_theme_id=>4000
,p_name=>'BORDERLESS'
,p_display_name=>'Borderless'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969565848056105774)
,p_theme_id=>4000
,p_name=>'DEFAULTPADDING'
,p_display_name=>'Default Padding'
,p_display_sequence=>30
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969565997058105774)
,p_theme_id=>4000
,p_name=>'HIDDEN'
,p_display_name=>'Hidden'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969566205984105774)
,p_theme_id=>4000
,p_name=>'NOPADDING'
,p_display_name=>'No Padding'
,p_display_sequence=>10
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969566364496105774)
,p_theme_id=>4000
,p_name=>'REMOVE_TOP_BORDER'
,p_display_name=>'Remove Top Border'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969566568244105774)
,p_theme_id=>4000
,p_name=>'SCROLLWITHSHADOWS'
,p_display_name=>'Scroll (with Shadows)'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969566808169105774)
,p_theme_id=>4000
,p_name=>'SIDEBAR'
,p_display_name=>'Sidebar'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969566973159105775)
,p_theme_id=>4000
,p_name=>'SLIMPADDING'
,p_display_name=>'Slim Padding'
,p_display_sequence=>20
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969571418290105776)
,p_theme_id=>4000
,p_name=>'2COLUMNNGRID'
,p_display_name=>'2 Columnn Grid'
,p_display_sequence=>1
,p_report_template_id=>wwv_flow_api.id(14969570952657105776)
,p_css_classes=>'a-BadgeList--cols'
,p_group_id=>wwv_flow_api.id(14969571174177105776)
,p_template_types=>'REPORT'
,p_is_advanced=>'N'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969571621690105777)
,p_theme_id=>4000
,p_name=>'3COLUMNGRID'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969571768821105777)
,p_theme_id=>4000
,p_name=>'4COLUMNGRID'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969572053505105777)
,p_theme_id=>4000
,p_name=>'5COLUMNGRID'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969572237100105777)
,p_theme_id=>4000
,p_name=>'FIXED'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969572365638105777)
,p_theme_id=>4000
,p_name=>'FLEXIBLEBOX'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969572593475105777)
,p_theme_id=>4000
,p_name=>'FLOATITEMS'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969573005112105777)
,p_theme_id=>4000
,p_name=>'LARGE'
,p_display_name=>'64px'
,p_display_sequence=>1
...
,p_group_id=>wwv_flow_api.id(14969572841877105777)
,p_template_types=>'REPORT'
,p_is_advanced=>'N'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969573161611105777)
,p_theme_id=>4000
,p_name=>'MEDIUM'
,p_display_name=>'48px'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969573407077105777)
,p_theme_id=>4000
,p_name=>'SMALL'
,p_display_name=>'32px'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969573578253105777)
,p_theme_id=>4000
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969573787701105778)
,p_theme_id=>4000
,p_name=>'XLARGE'
,p_display_name=>'96px'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969574042369105778)
,p_theme_id=>4000
,p_name=>'XXLARGE'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969574588272105778)
,p_theme_id=>4000
,p_name=>'DONOTWRAPTEXT'
,p_display_name=>'Do not wrap text'
,p_display_sequence=>1
,p_report_template_id=>wwv_flow_api.id(14969574328459105778)
,p_css_classes=>'a-LinksList--nowrap'
,p_template_types=>'REPORT'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969574768005105778)
,p_theme_id=>4000
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969574969303105778)
,p_theme_id=>4000
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969575977515105778)
,p_theme_id=>4000
,p_name=>'DISABLE'
,p_display_name=>'Disable'
,p_display_sequence=>1
,p_report_template_id=>wwv_flow_api.id(14969575474235105778)
,p_css_classes=>'a-Report--staticRowColors'
,p_group_id=>wwv_flow_api.id(14969575839092105778)
,p_template_types=>'REPORT'
,p_is_advanced=>'N'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969576447279105779)
,p_theme_id=>4000
,p_name=>'ENABLE'
...
,p_group_id=>wwv_flow_api.id(14969576183684105778)
,p_template_types=>'REPORT'
,p_is_advanced=>'N'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969576761473105779)
,p_theme_id=>4000
...
,p_group_id=>wwv_flow_api.id(14969576574668105779)
,p_template_types=>'REPORT'
,p_is_advanced=>'N'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969576984742105779)
,p_theme_id=>4000
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969577169665105779)
,p_theme_id=>4000
,p_name=>'NOBORDERS'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969577637912105779)
,p_theme_id=>4000
,p_name=>'STRETCH'
...
,p_group_id=>wwv_flow_api.id(14969577411508105779)
,p_template_types=>'REPORT'
,p_is_advanced=>'N'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969577784182105779)
,p_theme_id=>4000
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969578163009105779)
,p_theme_id=>4000
,p_name=>'ENABLE'
,p_display_name=>'Enable'
,p_display_sequence=>1
,p_report_template_id=>wwv_flow_api.id(14969577956725105779)
,p_css_classes=>'a-Report--rowHighlight'
,p_group_id=>wwv_flow_api.id(14969576183684105778)
,p_template_types=>'REPORT'
,p_is_advanced=>'N'
...
begin
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969578402973105779)
,p_theme_id=>4000
,p_name=>'HORIZONTALBORDERS'
,p_display_name=>'Horizontal Borders'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969578626563105779)
,p_theme_id=>4000
,p_name=>'INLINEBORDERS'
,p_display_name=>'Inline Borders'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969578789992105779)
,p_theme_id=>4000
,p_name=>'NOBORDERS'
,p_display_name=>'No Borders'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969578997229105779)
,p_theme_id=>4000
,p_name=>'STRETCH'
,p_display_name=>'Stretch'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969579170115105779)
,p_theme_id=>4000
,p_name=>'VERTICALBORDERS'
,p_display_name=>'Vertical Borders'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969582257921105781)
,p_theme_id=>4000
,p_name=>'DONOTWRAPTEXT'
,p_display_name=>'Do not wrap text'
,p_display_sequence=>1
,p_list_template_id=>wwv_flow_api.id(14969581888502105780)
,p_css_classes=>'a-LinksList--nowrap'
,p_template_types=>'LIST'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969582637819105781)
,p_theme_id=>4000
,p_name=>'FORALLITEMS'
...
,p_group_id=>wwv_flow_api.id(14969582450040105781)
,p_template_types=>'LIST'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969582853054105781)
,p_theme_id=>4000
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969582967228105781)
,p_theme_id=>4000
,p_name=>'SHOWBADGES'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969583249773105781)
,p_theme_id=>4000
,p_name=>'SHOWRIGHTARROW'
,p_display_name=>'Show Right Arrow'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969583369758105781)
,p_theme_id=>4000
,p_name=>'USEBRIGHTHOVERS'
,p_display_name=>'Use Bright Hovers'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969584034010105781)
,p_theme_id=>4000
,p_name=>'2COLUMNGRID'
,p_display_name=>'2 Column Grid'
,p_display_sequence=>1
,p_list_template_id=>wwv_flow_api.id(14969583469302105781)
,p_css_classes=>'a-MediaList--cols a-MediaList--2cols'
,p_group_id=>wwv_flow_api.id(14969583850764105781)
,p_template_types=>'LIST'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969584226043105781)
,p_theme_id=>4000
,p_name=>'3COLUMNGRID'
,p_display_name=>'3 Column Grid'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969584444948105781)
,p_theme_id=>4000
,p_name=>'4COLUMNGRID'
,p_display_name=>'4 Column Grid'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969584573365105781)
,p_theme_id=>4000
,p_name=>'5COLUMNGRID'
,p_display_name=>'5 Column Grid'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969584826738105781)
,p_theme_id=>4000
,p_name=>'HIDEBADGE'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969584983656105781)
,p_theme_id=>4000
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969585161508105781)
,p_theme_id=>4000
,p_name=>'HIDEICONS'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969585398032105781)
,p_theme_id=>4000
,p_name=>'HIDETITLE'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969585609404105781)
,p_theme_id=>4000
,p_name=>'SLIMLIST'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969585800073105781)
,p_theme_id=>4000
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969586184923105782)
,p_theme_id=>4000
,p_name=>'ADD_ACTIONS'
,p_display_name=>'Add Actions'
,p_display_sequence=>1
,p_list_template_id=>wwv_flow_api.id(14969585904373105781)
,p_css_classes=>'js-addActions'
,p_template_types=>'LIST'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969586388114105782)
,p_theme_id=>4000
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969587242163105782)
,p_theme_id=>4000
,p_name=>'SLIMPROGRESSLIST'
,p_display_name=>'Slim Progress List'
,p_display_sequence=>1
,p_list_template_id=>wwv_flow_api.id(14969586960348105782)
,p_css_classes=>'a-WizardSteps--slim'
,p_template_types=>'LIST'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969588030097105782)
,p_theme_id=>4000
,p_name=>'DONOTWRAPTEXT'
,p_display_name=>'Do not wrap text'
,p_display_sequence=>1
,p_list_template_id=>wwv_flow_api.id(14969587756062105782)
,p_css_classes=>'a-LinksList--nowrap'
,p_template_types=>'LIST'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969588183512105782)
,p_theme_id=>4000
,p_name=>'FORALLITEMS'
,p_display_name=>'For all items'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969588441573105782)
,p_theme_id=>4000
,p_name=>'FORTOPLEVELONLY'
,p_display_name=>'For top level only'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969588604906105782)
,p_theme_id=>4000
,p_name=>'SHOWBADGES'
,p_display_name=>'Show Badges'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969588859301105782)
,p_theme_id=>4000
,p_name=>'SHOWRIGHTARROW'
,p_display_name=>'Show Right Arrow'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969589016217105782)
,p_theme_id=>4000
,p_name=>'USEBRIGHTHOVERS'
,p_display_name=>'Use Bright Hovers'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969591123244105783)
,p_theme_id=>4000
,p_name=>'LEFT'
,p_display_name=>'Left'
,p_display_sequence=>1
,p_button_template_id=>wwv_flow_api.id(14969590736170105783)
,p_css_classes=>'a-Button--iconLeft'
,p_group_id=>wwv_flow_api.id(14969590939504105783)
,p_template_types=>'BUTTON'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969591365881105784)
,p_theme_id=>4000
,p_name=>'LEFT'
,p_display_name=>'Left'
,p_display_sequence=>1
,p_button_template_id=>wwv_flow_api.id(14969591221481105783)
,p_css_classes=>'a-Button--iconLeft'
,p_group_id=>wwv_flow_api.id(14969590939504105783)
,p_template_types=>'BUTTON'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969593135661105785)
,p_theme_id=>4000
,p_name=>'LARGELEFT'
,p_display_name=>'Large'
,p_display_sequence=>1
,p_css_classes=>'a-Button--gapLeft'
,p_group_id=>wwv_flow_api.id(14969592677495105785)
,p_template_types=>'BUTTON'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969593889637105785)
,p_theme_id=>4000
,p_name=>'LARGERIGHT'
,p_display_name=>'Large'
,p_display_sequence=>1
,p_css_classes=>'a-Button--gapRight'
,p_group_id=>wwv_flow_api.id(14969593478836105785)
,p_template_types=>'BUTTON'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969594279701105786)
,p_theme_id=>4000
,p_name=>'LEFTICON'
,p_display_name=>'Left'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969595152494105786)
,p_theme_id=>4000
,p_name=>'LARGE'
,p_display_name=>'Large'
,p_display_sequence=>3
,p_css_classes=>'a-Button--large'
,p_group_id=>wwv_flow_api.id(14969594724595105786)
,p_template_types=>'BUTTON'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969595494521105786)
,p_theme_id=>4000
,p_name=>'SMALLLEFT'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969595903486105786)
,p_theme_id=>4000
,p_name=>'SMALLRIGHT'
,p_display_name=>'Small'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969596674408105786)
,p_theme_id=>4000
,p_name=>'INNERBUTTON'
,p_display_name=>'Inner Button'
,p_display_sequence=>2
,p_css_classes=>'a-Button--pill'
,p_group_id=>wwv_flow_api.id(14969596276276105786)
,p_template_types=>'BUTTON'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969597111385105787)
,p_theme_id=>4000
,p_name=>'LASTBUTTON'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969597485137105787)
,p_theme_id=>4000
,p_name=>'FIRSTBUTTON'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969598357907105787)
,p_theme_id=>4000
,p_name=>'PRIMARY'
,p_display_name=>'Primary'
,p_display_sequence=>1
,p_css_classes=>'a-Button--primary'
,p_group_id=>wwv_flow_api.id(14969597934762105787)
,p_template_types=>'BUTTON'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969598729238105788)
,p_theme_id=>4000
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969599089053105788)
,p_theme_id=>4000
,p_name=>'SMALL'
,p_display_name=>'Small'
,p_display_sequence=>1
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969599532363105788)
,p_theme_id=>4000
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969600317312105788)
,p_theme_id=>4000
,p_name=>'AUTOWIDTH'
,p_display_name=>'Auto Width'
,p_display_sequence=>1
,p_css_classes=>'a-Form--autoWidthLabels'
,p_group_id=>wwv_flow_api.id(14969599941550105788)
,p_template_types=>'REGION'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969600740000105789)
,p_theme_id=>4000
,p_name=>'FIXEDWIDTH'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969601487527105789)
,p_theme_id=>4000
,p_name=>'LABELSABOVE'
,p_display_name=>'Labels Above'
,p_display_sequence=>1
,p_css_classes=>'a-Form--labelsAbove'
,p_group_id=>wwv_flow_api.id(14969601065427105789)
,p_template_types=>'REGION'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969602357045105789)
,p_theme_id=>4000
,p_name=>'ALIGNLABELSLEFT'
,p_display_name=>'Left'
,p_display_sequence=>1
,p_css_classes=>'a-Form--leftLabels'
,p_group_id=>wwv_flow_api.id(14969601919979105789)
,p_template_types=>'REGION'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969603157169105790)
,p_theme_id=>4000
,p_name=>'LABELAUTOWIDTH'
,p_display_name=>'Auto Width'
,p_display_sequence=>1
,p_css_classes=>'a-Form-fieldContainer--autoLabelWidth'
,p_group_id=>wwv_flow_api.id(14969602754706105789)
,p_template_types=>'FIELD'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969603476560105790)
,p_theme_id=>4000
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969603945352105790)
,p_theme_id=>4000
,p_name=>'FIXEDLARGE'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969604290700105790)
,p_theme_id=>4000
,p_name=>'FIXEDMEDIUM'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969605097373105790)
,p_theme_id=>4000
,p_name=>'180PX'
,p_display_name=>'180px'
,p_display_sequence=>10
,p_css_classes=>'h180'
,p_group_id=>wwv_flow_api.id(14969604729060105790)
,p_template_types=>'REGION'
,p_is_advanced=>'N'
);
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969605471257105791)
,p_theme_id=>4000
,p_name=>'240PX'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969605889137105791)
,p_theme_id=>4000
,p_name=>'320PX'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969606341897105791)
,p_theme_id=>4000
,p_name=>'480PX'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969606750037105791)
,p_theme_id=>4000
,p_name=>'540PX'
...
wwv_flow_api.create_template_option(
 p_id=>wwv_flow_api.id(14969607146171105791)
,p_theme_id=>4000
,p_name=>'640PX'
...
wwv_flow_api.create_message(
 p_id=>wwv_flow_api.id(15205442431383114811)
,p_name=>'ACTIVE'
,p_message_language=>'en-us'
,p_message_text=>'Active'
);
wwv_flow_api.create_message(
 p_id=>wwv_flow_api.id(15205442942465118056)
,p_name=>'INACTIVE'
,p_message_language=>'en-us'
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(14970058217682064185)
,p_name=>'DemoAuth'
...
wwv_flow_api.create_plugin(
 p_id=>wwv_flow_api.id(14969615484624198155)
...
wwv_flow_api.create_plugin_attribute(
 p_id=>wwv_flow_api.id(14969615764761198156)
,p_plugin_id=>wwv_flow_api.id(14969615484624198155)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(14969616252755198156)
,p_plugin_attribute_id=>wwv_flow_api.id(14969615764761198156)
,p_display_sequence=>10
,p_display_value=>'ADMIN: Ability to manage flow developer privileges'
,p_return_value=>'ADMIN'
);
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(14969616740356198156)
,p_plugin_attribute_id=>wwv_flow_api.id(14969615764761198156)
,p_display_sequence=>20
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(14969617195164198157)
,p_plugin_attribute_id=>wwv_flow_api.id(14969615764761198156)
,p_display_sequence=>30
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(14969617721344198157)
,p_plugin_attribute_id=>wwv_flow_api.id(14969615764761198156)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(14969618220540198157)
,p_plugin_attribute_id=>wwv_flow_api.id(14969615764761198156)
,p_display_sequence=>50
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(14969618713952198157)
,p_plugin_attribute_id=>wwv_flow_api.id(14969615764761198156)
,p_display_sequence=>60
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(14969619183353198157)
,p_plugin_attribute_id=>wwv_flow_api.id(14969615764761198156)
,p_display_sequence=>70
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(14969619706057198157)
,p_plugin_attribute_id=>wwv_flow_api.id(14969615764761198156)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(14969620183122198158)
,p_plugin_attribute_id=>wwv_flow_api.id(14969615764761198156)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(14969620681091198158)
,p_plugin_attribute_id=>wwv_flow_api.id(14969615764761198156)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(14969621241777198158)
,p_plugin_attribute_id=>wwv_flow_api.id(14969615764761198156)
...
wwv_flow_api.create_plugin_attr_value(
 p_id=>wwv_flow_api.id(14969621697068198158)
,p_plugin_attribute_id=>wwv_flow_api.id(14969615764761198156)
...
wwv_flow_api.create_user_interface(
 p_id=>wwv_flow_api.id(14969539900263096493)
,p_ui_type_name=>'DESKTOP'
...
,p_global_page_id=>0
,p_navigation_list_template_id=>wwv_flow_api.id(14969586462368105782)
...
wwv_flow_api.create_page(
 p_id=>0
,p_user_interface_id=>wwv_flow_api.id(14969539900263096493)
,p_name=>'Global Page'
,p_page_mode=>'NORMAL'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(14969608668034153276)
,p_plug_name=>'APEX 5 - Header'
,p_region_css_classes=>'a-Header apex-app-builder'
,p_plug_template=>wwv_flow_api.id(14969554172082105770)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(14969608847830153277)
,p_plug_name=>'APEX 5 - Header Left'
,p_parent_plug_id=>wwv_flow_api.id(14969608668034153276)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(14969608958052153278)
,p_plug_name=>'APEX 5 - Logo'
,p_parent_plug_id=>wwv_flow_api.id(14969608847830153277)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(14969608999935153279)
...
,p_include_in_reg_disp_sel_yn=>'N'
,p_plug_display_point=>'BODY'
,p_list_id=>wwv_flow_api.id(14969728310136515013)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(14969586462368105782)
,p_plug_query_row_template=>1
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(14969609159926153280)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(14969609241704153281)
,p_plug_name=>'APEX 5 - Search'
,p_parent_plug_id=>wwv_flow_api.id(14969609159926153280)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(14969609357029153282)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(14969609622836153285)
,p_plug_name=>'Administration Menu'
,p_region_name=>'adminMenu'
,p_parent_plug_id=>wwv_flow_api.id(14969609357029153282)
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(14969554172082105770)
,p_plug_display_sequence=>10
,p_include_in_reg_disp_sel_yn=>'N'
,p_plug_display_point=>'BODY'
,p_list_id=>wwv_flow_api.id(14969696228676392474)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(14969585904373105781)
,p_plug_query_row_template=>1
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(14969609715691153286)
...
,p_include_in_reg_disp_sel_yn=>'N'
,p_plug_display_point=>'BODY'
,p_list_id=>wwv_flow_api.id(14969704152923392478)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(14969585904373105781)
,p_plug_query_row_template=>1
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(14969802253614054188)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(14969609826990153287)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(14969609926354153288)
,p_plug_name=>'APEX 5 - Control Bar Left'
,p_parent_plug_id=>wwv_flow_api.id(14969609826990153287)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(14969610128945153290)
,p_plug_name=>'APEX 5 - Breadcrumb'
,p_parent_plug_id=>wwv_flow_api.id(14969609926354153288)
,p_component_template_options=>'#DEFAULT#'
,p_plug_display_sequence=>10
,p_include_in_reg_disp_sel_yn=>'N'
,p_plug_display_point=>'BODY'
,p_menu_id=>wwv_flow_api.id(15230340359532763581)
,p_plug_source_type=>'NATIVE_BREADCRUMB'
,p_menu_template_id=>wwv_flow_api.id(14969591928270105784)
,p_plug_query_row_template=>1
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(14969610013134153289)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(14969609418046153283)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(14969609357029153282)
,p_button_name=>'ADMINISTRATION'
,p_button_static_id=>'header-adminMenu'
,p_button_action=>'DEFINED_BY_DA'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(14969591730581105784)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(14969609558448153284)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(14969610243687153291)
,p_button_sequence=>50
,p_button_plug_id=>wwv_flow_api.id(14969610013134153289)
,p_button_name=>'DEVELOPER_COMMENT'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#'
,p_button_template_id=>wwv_flow_api.id(14969591780837105784)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(14969610277274153292)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(14969610451538153293)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(14969610514137153294)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(14969610625355153295)
...
,p_step_template=>wwv_flow_api.id(14969543341966105767)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(14969608401281153273)
,p_plug_name=>'About'
,p_region_template_options=>'#DEFAULT#:a-Region--slimPadding:a-Region--sideRegion'
,p_plug_template=>wwv_flow_api.id(14969562301061105773)
,p_plug_display_sequence=>10
,p_include_in_reg_disp_sel_yn=>'N'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(14969608539459153274)
,p_plug_name=>'Tasks'
...
,p_plug_display_point=>'REGION_POSITION_03'
,p_plug_item_display_point=>'BELOW'
,p_list_id=>wwv_flow_api.id(14969614800943198152)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(14969581888502105780)
,p_plug_query_row_template=>1
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(14969610824601153297)
...
,p_include_in_reg_disp_sel_yn=>'Y'
,p_plug_display_point=>'BODY'
,p_list_id=>wwv_flow_api.id(14969795882255175679)
,p_plug_source_type=>'NATIVE_LIST'
,p_list_template_id=>wwv_flow_api.id(14969581660693105780)
,p_plug_query_row_template=>1
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
,p_plug_column_width=>'apex-col--bottomBorder'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(14969611024829153299)
,p_plug_name=>'Pages'
,p_region_name=>'apex_pages_irr'
,p_region_template_options=>'#DEFAULT#:a-IRR-region--noOuterBorders'
,p_component_template_options=>'#DEFAULT#'
,p_plug_template=>wwv_flow_api.id(14969559678626105772)
,p_plug_display_sequence=>20
,p_include_in_reg_disp_sel_yn=>'N'
,p_plug_display_point=>'BODY'
,p_plug_source=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(14969611159545153300)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(14969611217618153301)
,p_db_column_name=>'ID'
,p_display_order=>1
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(14969611435506153303)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(14969611714924153306)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(14969611823693153307)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(14969612640651153315)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(14969612406356153313)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(14969612177176153311)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(14969612129864153310)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(14969611339527153302)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(14969612891510153318)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(14969611535046153304)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(14969612978862153319)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(14969613158562153320)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(14969802280900054189)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(14969613347157153322)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(14969801256834054178)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(14969800744389054173)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(14969800921606054175)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(14969801032209054176)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(14969801150105054177)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(14969801333455054179)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(14969801454979054180)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(14969800786880054174)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(14969611861912153308)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(14969612049069153309)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(14969612284821153312)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(14969801519953054181)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(14969612830147153317)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(14969611589572153305)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(14969612745587153316)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(14969612545493153314)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(14969815538593063664)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(14969610915054153298)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(14969610824601153297)
,p_button_name=>'EDIT_APPLICATION_PROPERTIES'
,p_button_action=>'REDIRECT_PAGE'
,p_button_template_options=>'#DEFAULT#:a-Button--small'
,p_button_template_id=>wwv_flow_api.id(14969590571274105783)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(14969801627717054182)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(14969611024829153299)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(15013493124766244451)
...
wwv_flow_api.create_install(
 p_id=>wwv_flow_api.id(15206529945087641461)
